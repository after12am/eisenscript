...
console.log('\n\n\n\n\nTesting ast generated by jison...'.info)
console.log('\n= Comments');
console.log('\n-----------------------------------------'.prompt);
...
describe('set maxobjects 100', function() {
  ...
  var ast = parser.parse(source);
  assert.ok(ast[0].type == 'SET');
  assert.ok(ast[0].name == 'MAXOBJECTS');
  assert.ok(ast[0].value == 100);
});
...
describe('set background #ffffff', function() {
  ...
  var ast = parser.parse(source);
  assert.ok(ast[0].type == 'SET');
  assert.ok(ast[0].name == 'BACKGROUND');
...
describe('rule R1 maxdepth 10 { box }', function() {
  ...
  assert.ok(ast[0].modifiers[0].name === 'MAXDEPTH');
  assert.ok(ast[0].modifiers[0].value === 10);
...
describe('rule R1 weight 10.1 { box }', function() {
  ...
  assert.ok(ast[0].type === 'RULE');
  assert.ok(ast[0].id === 'R1');
  assert.ok(ast[0].modifiers[0].name === 'WEIGHT');
  assert.ok(ast[0].modifiers[0].value === 10.1);
  assert.ok(ast[0].body.length === 1);
});
...
describe('{ x 1.2 } box', function() {
  ...
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'XSHIFT');
  assert.ok(ast[0].loop[0].attr[0].value == 1.2);
  assert.ok(ast[0].init);
});
...
describe('{ y 1.2 } box', function() {
  ...
  assert.ok(ast[0].id == 'box');
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'YSHIFT');
  assert.ok(ast[0].loop[0].attr[0].value == 1.2);
  assert.ok(ast[0].init);
});
...
describe('{ z 1.2 } box', function() {
  ...
  assert.ok(ast[0].id == 'box');
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'ZSHIFT');
  assert.ok(ast[0].loop[0].attr[0].value == 1.2);
  assert.ok(ast[0].init);
});
...
describe('{ rx 1.2 } box', function() {
  ...
  assert.ok(ast[0].id == 'box');
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'ROTATEX');
  assert.ok(ast[0].loop[0].attr[0].value == 1.2);
  assert.ok(ast[0].init);
});
...
describe('{ ry 1.2 } box', function() {
  ...
  assert.ok(ast[0].id == 'box');
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'ROTATEY');
  assert.ok(ast[0].loop[0].attr[0].value == 1.2);
  assert.ok(ast[0].init);
});
...
describe('{ rz 1.2 } box', function() {
  ...
  assert.ok(ast[0].id == 'box');
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'ROTATEZ');
  assert.ok(ast[0].loop[0].attr[0].value == 1.2);
  assert.ok(ast[0].init);
});
...
describe('{ s 1.2 } box', function() {
  ...
  assert.ok(ast[0].id == 'box');
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'SIZE');
  assert.ok(ast[0].loop[0].attr[0].value[0] === 1.2);
  assert.ok(ast[0].loop[0].attr[0].value[1] === 1.2);
  assert.ok(ast[0].loop[0].attr[0].value[2] === 1.2);
  assert.ok(ast[0].init);
});
...
describe('{ s 2.1 2.2 2.3 } box', function() {
  ...
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'SIZE');
  assert.ok(ast[0].loop[0].attr[0].value[0] === 2.1);
  assert.ok(ast[0].loop[0].attr[0].value[1] === 2.2);
  assert.ok(ast[0].loop[0].attr[0].value[2] === 2.3);
  assert.ok(ast[0].init);
});
...
describe('{ s 2.1 2.2 2.3 } box', function() {
  ...
  assert.ok(ast[0].id == 'box');
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'MATRIX');
  assert.ok(ast[0].loop[0].attr[0].value[0] === 2.1);
  assert.ok(ast[0].loop[0].attr[0].value[1] === 2.2);
  assert.ok(ast[0].loop[0].attr[0].value[2] === 2.3);
  assert.ok(ast[0].loop[0].attr[0].value[3] === 2.4);
  assert.ok(ast[0].loop[0].attr[0].value[4] === 2.5);
  assert.ok(ast[0].loop[0].attr[0].value[5] === 2.6);
  assert.ok(ast[0].loop[0].attr[0].value[6] === 2.7);
  assert.ok(ast[0].loop[0].attr[0].value[7] === 2.8);
  assert.ok(ast[0].loop[0].attr[0].value[8] === 2.9);
  assert.ok(ast[0].init);
});
...
describe('{ h 1.2 } box', function() {
  ...
  assert.ok(ast[0].id == 'box');
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'HUE');
  assert.ok(ast[0].loop[0].attr[0].value == 1.2);
  assert.ok(ast[0].init);
});
...
describe('{ sat 1.2 } box', function() {
  ...
  assert.ok(ast[0].id == 'box');
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'SATURATION');
  assert.ok(ast[0].loop[0].attr[0].value == 1.2);
  assert.ok(ast[0].init);
});
...
describe('{ b 1.2 } box', function() {
  ...
  assert.ok(ast[0].id == 'box');
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'BRIGHTNESS');
  assert.ok(ast[0].loop[0].attr[0].value == 1.2);
  assert.ok(ast[0].init);
});
...
describe('{ a 1.2 } box', function() {
  ...
  assert.ok(ast[0].id == 'box');
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'ALPHA');
  assert.ok(ast[0].loop[0].attr[0].value == 1.2);
  assert.ok(ast[0].init);
});
...
describe('{ color #fff } box', function() {
  ...
  assert.ok(ast[0].id == 'box');
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'COLOR');
  assert.ok(ast[0].loop[0].attr[0].value == '#fff');
  assert.ok(ast[0].init);
});
...
describe('{ color #ffffff } box', function() {
  ...
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'COLOR');
  assert.ok(ast[0].loop[0].attr[0].value == '#ffffff');
  assert.ok(ast[0].init);
});
...
describe('{ color red } box', function() {
  ...
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'COLOR');
  assert.ok(ast[0].loop[0].attr[0].value == 'red');
  assert.ok(ast[0].init);
});
...
describe('{ color random } box', function() {
  ...
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'COLOR');
  assert.ok(ast[0].loop[0].attr[0].value == 'random');
  assert.ok(ast[0].init);
});
...
describe('{ blend #fff 0.5 } box', function() {
  ...
  assert.ok(ast[0].id == 'box');
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'BLEND');
  assert.ok(ast[0].loop[0].attr[0].color == '#fff');
  assert.ok(ast[0].loop[0].attr[0].strength == 0.5);
  assert.ok(ast[0].init);
});
...
describe('{ blend #ffffff 0.5 } box', function() {
  ...
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'BLEND');
  assert.ok(ast[0].loop[0].attr[0].color == '#ffffff');
  assert.ok(ast[0].loop[0].attr[0].strength == 0.5);
  assert.ok(ast[0].init);
});
...
describe('{ blend red 0.5 } box', function() {
  ...
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'BLEND');
  assert.ok(ast[0].loop[0].attr[0].color == 'red');
  assert.ok(ast[0].loop[0].attr[0].strength == 0.5);
  assert.ok(ast[0].init);
});
...
describe('{ blend random 0.5 } box', function() {
  ...
  assert.ok(ast[0].loop[0].iter == 1);
  assert.ok(ast[0].loop[0].attr[0].name == 'BLEND');
  assert.ok(ast[0].loop[0].attr[0].color == 'random');
  assert.ok(ast[0].loop[0].attr[0].strength == 0.5);
  assert.ok(ast[0].init);
});
...
describe('{ set colorpool randomhue', function() {
  ...
  var ast = parser.parse(source);
  assert.ok(ast[0].type == 'SET');
  assert.ok(ast[0].name == 'COLORPOOL');
...
describe('box', function() {
  ...
  assert.ok(ast[0].type == 'STATEMENT');
  assert.ok(ast[0].id == 'box');
  assert.ok(ast[0].loop.length == 0);
  assert.ok(ast[0].init == true);
});
