...
exports.OBJExporter.prototype.exports = function(meshes) {
  this.buff = sprintf(this.header);
  for (var i = 0; i < meshes.length; i++) this.exportMesh(meshes[i], i);
  return this.buff;
}

exports.OBJExporter.prototype.exportMesh = function(mesh, i) {
  var that = this;
...
exports.OBJExporter.prototype.exportObject = function(object, i) {
