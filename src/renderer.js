...
exports.TestRenderer.prototype.add = function(params) {
  var geo, mat;
  switch (params.name) {
    case 'box': geo = this.geometry.cube; break;
    case 'sphere': geo = this.geometry.sphere; break;
    case 'grid': params.wireframe = true; geo = this.geometry.cube; break;
  }
  ...
  switch (this.materialType) {
    case 'lambert': mat = new THREE.MeshLambertMaterial(_.extend(params, { transparent: true })); break;
