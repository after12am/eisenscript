...
exports.TestRenderer = function(option) {
  ...
  if (!option.width || !option.height) {
    throw new Error(
      "ReferenceError: option.width and option.height has to be rquired.",
...
exports.TestRenderer.prototype.add = function(params) {
  var geo, mat;
  switch (params.name) {
    case Primitive.Box: geo = this.geometry.cube; break;
    case Primitive.Sphere: geo = this.geometry.sphere; break;
    case Primitive.Grid: params.wireframe = true; geo = this.geometry.cube; break;
  }
  ...
  switch (this.materialType) {
    case MaterialType.Lambert: mat = new THREE.MeshLambertMaterial(_.extend(params, { transparent: true })); break;
    default: mat = new THREE.MeshNormalMaterial(_.extend(params, { transparent: true })); break;
  }
  // add primitive
